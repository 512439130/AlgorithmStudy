...
//        System.out.println("threeSum: "+threeSum3(num));
//        int[] num = new int[]{2,3,1,5};
//        int[] num = new int[]{3,3};
//        int[] num = new int[]{3,2,4};
//        int[] num = new int[]{1,4,8,2,9};
//        System.out.println(Arrays.toString(twoSum1(num,6)));
...
//        Set<Integer> set= new HashSet<>();
     ...
     * 空间复杂度 O(N) = O(1)
     */
    public static List<List<Integer>> threeSum3(int[] numbers) {
        // ### 解题思路
        // #### 一、常规思路:
     ...
     * @return
     */
    public static int[] twoSumOrderly1(int[] numbers, int target) {
        //双指针解法
        int[] result = new int[2];
        if(numbers == null || numbers.length < 2) return result;
        int left = 0;
     ...
     * @return
     */
    public static int[] twoSumOrderly2(int[] numbers, int target) {
        //二分查找解法
        int[] result = new int[2];
        if(numbers == null || numbers.length < 2) return result;
        int mid;
